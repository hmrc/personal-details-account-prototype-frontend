...
class AddressControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val addressRoute = routes.AddressController.onPageLoad(NormalMode).url
  ...
  "Address Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AddressPage, "answer").success.value
